...
translate_to_chinese = Translator(to_lang="zh-TW")
    ...
    def initialize(self):
        if "retweeted_status" in self.status_tweet:
            if "extended_tweet" in self.status_tweet["retweeted_status"]:
                self.text = translate_to_chinese.translate(self.status_tweet["retweeted_status"]["extended_tweet"]["full_text"])
            elif "full_text" in self.status_tweet["retweeted_status"]:
                self.text = translate_to_chinese.translate(self.status_tweet["retweeted_status"]["full_text"])
            else:
                self.text = translate_to_chinese.translate(self.status_tweet["retweeted_status"]["text"])
        elif "extended_tweet" in self.status_tweet:
            self.text = translate_to_chinese.translate(self.status_tweet["extended_tweet"]["full_text"])
        elif "full_text" in self.status_tweet:
            self.text = translate_to_chinese.translate(self.status_tweet["full_text"])
        else:
            self.text = translate_to_chinese.translate(self.status_tweet["text"])
